          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="form-group">
                ...
                <span>Link: <a target="_blank" href="<?php echo getLinkModule('portfolios', old('slug', $oldData))  ?>" class="text-url"><?php echo getLinkModule('portfolios', old('slug', $oldData))  ?></a></span>
